...
public class RegisterServiceImpl implements RegisterService {
    ...
    /**
     * Generate new short URL and check this url in db.
     * If this short url generated earlier then are generating new shortUrl.
     * MAX_COUNT_ATTEMPTS is maximum value of attempts to generate new url.
     *          
     * @return    new generated short url  
     *            else NULL   
     */
    protected String generateUrl() {
        for (int i=0; i< MAX_COUNT_ATTEMPTS; i++) {
            String generatedShortUrl = RandomStringUtils.randomAlphabetic(6);
            Optional<RegisterUrl> registerUrl =  registerRepository.findOneByShortUrl(generatedShortUrl);
